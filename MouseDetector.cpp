...
void MouseDetector::setCenterColorThreshold(int threshold) {
	...
	lowerCenter = cv::Scalar(centerHSV[0]-centerThresh,centerHSV[1]-50,centerHSV[2]-50);
	upperCenter = cv::Scalar(centerHSV[0]+centerThresh,centerHSV[1]+50,centerHSV[2]+50);
}
...
void MouseDetector::setScrollColorThreshold(int threshold) {
	...
	lowerScroll = cv::Scalar(scrollHSV[0]-scrollThresh,scrollHSV[1]-20,scrollHSV[2]-20);
	upperScroll = cv::Scalar(scrollHSV[0]+scrollThresh,scrollHSV[1]+20,scrollHSV[2]+20);
}
